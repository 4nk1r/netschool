...
fun Android13NavigationTransition(
    ...
    val coefficient = 8
    val animationSpec = tween<IntOffset>(easing = FastOutExtraSlowInInterpolator())
...
private class FastOutExtraSlowInInterpolator : Easing {
    ...
    private val fastOutExtraSlowInInterpolator = PathInterpolatorCompat.create(Path().apply {
        moveTo(0f, 0f)
