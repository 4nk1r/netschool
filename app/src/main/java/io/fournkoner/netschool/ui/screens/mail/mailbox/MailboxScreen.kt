...
import io.fournkoner.netschool.ui.screens.mail.message.MailMessageScreen
        ...
        val isRefreshing by remember {
            derivedStateOf {
                if (current == Mailbox.INBOX) {
                    inboxMessages.loadState.refresh is LoadState.Loading
                } else {
                    sentMessages.loadState.refresh is LoadState.Loading
                }
            }
        }
        ...
        Row(
            modifier = Modifier
                ...
                .background(
                    animateColorAsState(
                        if (isUnread) {
                            LocalNetSchoolColors.current.accentMain.copy(alpha = 0.2f)
                        } else {
